...
from paths import PROCESSED_TRAINING_WITH_MIN_PRED, AST_MODEL_STABLE

TARGET_STAT = "AST"

# ---------- Stats Relevant for Assists ----------
...
# ---------- Save Model ----------
with open(AST_MODEL_STABLE, "wb") as f:
    pickle.dump(model, f)
print(f"💾 Model saved to {AST_MODEL_STABLE}")
