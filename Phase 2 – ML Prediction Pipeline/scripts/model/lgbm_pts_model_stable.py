...
from paths import PROCESSED_TRAINING_WITH_MIN_PRED, PTS_MODEL_STABLE

TARGET_STAT = "PTS"

# ---------- Stats Relevant for Points ----------
...
# ---------- Save Model ----------
with open(PTS_MODEL_STABLE, "wb") as f:
    pickle.dump(model, f)
print(f"💾 Model saved to {PTS_MODEL_STABLE}")
